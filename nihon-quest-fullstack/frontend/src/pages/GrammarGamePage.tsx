...
export default function GrammarGamePage() {
                ...
                <Card className={`border-4 transition-all ${
                  ...
                  <CardContent className="p-4">
                    <div className="text-center">
                      <div className="text-3xl sm:text-4xl mb-2">{pair.emoji}</div>
                      <div className="text-xl sm:text-2xl font-bold mb-1">{pair.japanese}</div>
                      {userMode === 'kid' && (
            ...
            return (
              ...
              >
                <Card className={`border-4 transition-all ${
                  ...
                  <CardContent className="p-4">
                    <div className="text-center">
                      <div className="text-base sm:text-xl font-semibold">{pair.english}</div>
                      {isMatched && <div className="text-2xl mt-2">✓</div>}
                    </div>
                  </CardContent>
                </Card>
        ...
        <Card className="border-4 border-purple-200 mb-6">
          <CardContent className="pt-6">
            <div className="text-center mb-6">
              ...
              {/* Sentence with blank */}
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold mb-3 sm:mb-4 flex items-center justify-center gap-2 flex-wrap">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-xl mx-auto">
              {shuffleArray(options).slice(0, 6).map((option) => (
                <motion.button
                  ...
                  className={`p-4 sm:p-6 rounded-xl text-2xl sm:text-3xl font-bold border-2 sm:border-4 transition-all ${
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 py-4 sm:py-8">
      <div className="max-w-7xl mx-auto px-3 sm:px-4">
        ...
        <div className="text-center mb-4 sm:mb-8">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-2 sm:gap-4 mb-4 sm:mb-6 px-2">
            <div className="flex gap-2 bg-white rounded-full p-2 shadow-lg w-full sm:w-auto justify-center">
              <Button
          ...
          {/* Stats */}
          <div className="flex flex-wrap justify-center gap-3 sm:gap-6 text-base sm:text-lg mb-4 sm:mb-6">
        ...
        {/* Game Mode Selector */}
        <Card className="mb-4 sm:mb-8 border-2 sm:border-4 border-purple-200">
          <CardContent className="pt-6">
        ...
        {!showCelebration ? (
          ...
          /* Celebration Screen */
          <Card className="border-2 sm:border-4 border-yellow-400 bg-gradient-to-br from-yellow-50 to-orange-50 mx-2 sm:mx-0">
            <CardContent className="pt-8 sm:pt-12 pb-8 sm:pb-12">
              <div className="text-center">
                ...
                <div className="text-4xl sm:text-5xl lg:text-6xl font-bold text-primary mb-6 sm:mb-8">
                  {score} Points!
                </div>
                <Button
                  onClick={() => {
