...
export default function KanjiPage() {
  ...
  const [isJapanese, setIsJapanese] = useState(true) // Japanese first!
    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-6">
      ...
      >
        <div className="flex items-center justify-between mb-2">
          <h1 className="text-3xl sm:text-4xl font-bold text-primary flex items-center gap-2">
            ...
            {isJapanese ? '漢字べんきょう' : '漢字 Kanji Learning'}
          </h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-6">
        ...
        >
          ...
          <div className="text-sm text-blue-600">{isJapanese ? 'べんきょうした' : 'Learned'}</div>
        </motion.div>
        ...
        >
          ...
          <div className="text-sm text-green-600">{isJapanese ? 'しんちょく' : 'Progress'}</div>
        </motion.div>
        ...
        >
          ...
          <div className="text-sm text-purple-600">{isJapanese ? 'ごうけい' : 'Total'}</div>
        </motion.div>
        ...
        >
          ...
          <div className="text-sm text-orange-600">{isJapanese ? 'レベル' : 'Level'}</div>
        </motion.div>
      </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <div className="font-bold text-orange-700 mb-1">
                {isJapanese ? 'べんきょうのヒント：' : 'Learning Tips:'}
              </div>
              <ul className="text-sm text-orange-600 space-y-1">
                {isJapanese ? (
                  <>
                    <li>• <strong>ビジュアル:</strong> えもじの絵で漢字をおぼえよう</li>
                    <li>• <strong>ごろあわせ:</strong> おもしろいストーリーでおぼえる</li>
                    <li>• <strong>ひらがな:</strong> 知ってる音とつなげる</li>
                    <li>• <strong>れい:</strong> 本当の日本語の言葉で見る</li>
                    <li>• <strong>かきじゅん:</strong> ただしく書くことをまなぶ</li>
                  </>
                ) : (
                  <>
      ...
      <div className="mb-6">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder={isJapanese ? '漢字、読み方、意味をさがす...' : 'Search kanji, reading, or meaning...'}
            value={searchTerm}
          ...
          {selectedKanji ? (
            ...
            >
              <div className="text-center mb-6">
                ...
                >
                  {learnedKanji.has(selectedKanji.kanji) 
                    ? (isJapanese ? '✓ べんきょうした' : '✓ Learned')
                    : (isJapanese ? 'べんきょうしたにする' : 'Mark as Learned')}
                </button>
              </div>
