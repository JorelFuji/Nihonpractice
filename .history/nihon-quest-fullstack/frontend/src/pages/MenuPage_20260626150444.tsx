...
import { 
  Home, GraduationCap, BookMarked, Baby, MessageSquare, BookOpen, 
...
const QUICK_STATS = [
  { label: 'Total Features', value: '16+', icon: Sparkles, color: 'text-yellow-600' },
  { label: 'Learning Modes', value: '8', icon: Target, color: 'text-blue-600' },
  { label: 'Games', value: '5', icon: Gamepad2, color: 'text-green-600' },
  { label: 'Tools', value: '3', icon: Settings, color: 'text-purple-600' }
]
