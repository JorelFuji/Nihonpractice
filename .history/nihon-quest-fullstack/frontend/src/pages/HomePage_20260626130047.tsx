    ...
    <div className="max-w-6xl mx-auto px-5 py-8 pb-24">
      ...
      <div className="grid md:grid-cols-7 gap-3 mb-8">
        ...
        <Link to="/grammar-game" className="block">
          <div className="bg-gradient-to-br from-yellow-50 via-orange-50 to-pink-50 rounded-xl p-5 border-2 border-orange-300/50 hover:border-orange-500 transition-all hover:shadow-lg transform hover:scale-105">
            <div className="text-4xl mb-2">🎴</div>
            <h4 className="font-bold mb-1">Grammar Game ✨</h4>
            <p className="text-sm text-muted-foreground">Match & learn particles</p>
          </div>
        </Link>
        <Link to="/sentence-game" className="block">
          <div className="bg-gradient-to-br from-purple-50 via-pink-50 to-yellow-50 rounded-xl p-5 border-2 border-purple-300/50 hover:border-purple-500 transition-all hover:shadow-lg transform hover:scale-105">
            <div className="text-4xl mb-2">🎮</div>
            <h4 className="font-bold mb-1">SOV Game ✨</h4>
            <p className="text-sm text-muted-foreground">Learn sentence order</p>
          </div>
        </Link>
