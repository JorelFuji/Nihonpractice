          ...
          <CardContent className="pt-6">
            <div className="flex gap-4 mb-4">
              ...
              <select
                ...
                className="h-12 px-4 border-2 border-purple-200 rounded-lg"
              >
              ...
              >
                <div className="p-6">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <div className="text-5xl mb-2">{selectedLesson.emoji}</div>
                  ...
                  <div className="flex gap-3">
                    <Button size="lg" className="flex-1 bg-gradient-to-r from-purple-500 to-pink-500">
