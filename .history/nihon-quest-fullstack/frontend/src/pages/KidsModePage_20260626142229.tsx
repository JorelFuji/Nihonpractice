...
import { Star, Trophy, RotateCcw, Sparkles, ArrowRight } from 'lucide-react'
...
const HIRAGANA_CARDS: PictureCard[] = [
  { id: 'a', character: 'あ', romanji: 'a', emoji: '🍎', image: 'Apple' },
  { id: 'i', character: 'い', romanji: 'i', emoji: '🦷', image: 'Tooth' },
  { id: 'u', character: 'う', romanji: 'u', emoji: '🐰', image: 'Rabbit' },
  { id: 'e', character: 'え', romanji: 'e', emoji: '✏️', image: 'Pencil' },
  { id: 'o', character: 'お', romanji: 'o', emoji: '👑', image: 'King' },
  { id: 'ka', character: 'か', romanji: 'ka', emoji: '🚗', image: 'Car' },
  { id: 'ki', character: 'き', romanji: 'ki', emoji: '🌳', image: 'Tree' },
  { id: 'ku', character: 'く', romanji: 'ku', emoji: '☁️', image: 'Cloud' },
]

const KATAKANA_CARDS: PictureCard[] = [
  { id: 'a', character: 'ア', romanji: 'a', emoji: '🍦', image: 'Ice Cream' },
  { id: 'i', character: 'イ', romanji: 'i', emoji: '🍓', image: 'Strawberry' },
  { id: 'u', character: 'ウ', romanji: 'u', emoji: '🎾', image: 'Tennis' },
  { id: 'e', character: 'エ', romanji: 'e', emoji: '🏃', image: 'Running' },
  { id: 'o', character: 'オ', romanji: 'o', emoji: '🐺', image: 'Wolf' },
  { id: 'ka', character: 'カ', romanji: 'ka', emoji: '📷', image: 'Camera' },
  { id: 'ki', character: 'キ', romanji: 'ki', emoji: '🔑', image: 'Key' },
  { id: 'ku', character: 'ク', romanji: 'ku', emoji: '🍪', image: 'Cookie' },
]
