        ...
        <div className="max-w-6xl mx-auto px-3 sm:px-4">
          ...
          >
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 rounded-xl p-4 sm:p-6 shadow-xl hover:shadow-2xl transition-all relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 bg-yellow-400 text-yellow-900 text-xs sm:text-sm px-3 py-1 rounded-bl-lg font-bold animate-pulse">
                ✨ NEW!
              </div>
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-white/90 text-sm sm:text-base">
                    Try our new Flutter-powered games with native mobile feel!
                  </p>
                  <div className="mt-2 inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-white text-sm font-semibold">
